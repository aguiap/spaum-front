...
import {InputCourse, UlCourses} from "@/components/console/CoursesList/styled";
                                ...
                                <li>
                                    ...
                                    <div>
                                        <Tooltip
                                            ...
                                            arrow
                                        >
                                            <IconButton className={css`margin-right: ${courses[key].id ? 0 : '1.2rem'}`}
                                                ...
                                                <Image
                                                    ...
                                                    width={courses[key].id ? 35 : 40}
                                                    height={courses[key].id ? 35 : 40}
                                                ></Image>
                                            </IconButton>
                                        </Tooltip>
                                    </div>
